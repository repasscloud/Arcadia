...
namespace CTAIntentModel_v2.ConsoleApp
{
    ...
    {
        public const string RetrainFilePath =  @"/Users/danijeljw/Developer/Arcadia/Arcadia.ML/intent-data-2024-12-17.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"Text",outputColumnName:@"Text")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.LbfgsMaximumEntropy(new LbfgsMaximumEntropyMulticlassTrainer.Options(){L1Regularization=0.070430435F,L2Regularization=0.031352725F,LabelColumnName=@"Label",FeatureColumnName=@"Features"}))      
